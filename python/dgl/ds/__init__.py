...
def sample_neighbors(g, num_vertices, device_min_vids, device_min_eids, nodes, fanout):
    return sampling.sample_neighbors(g, num_vertices, device_min_vids, device_min_eids, nodes, fanout, DS_CONTEXT)
